...
public class ImageGallaryAdapter2 extends RecyclerView.Adapter<examViewHolder> {
    ...
    public ImageGallaryAdapter2(List<examData> list, Context context, ClickListiner listiner) {
        this.list = list;
